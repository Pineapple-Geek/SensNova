...
<head>
	...
	<link rel="shortcut icon" href="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/images/gt_favicon.png">
	
	<link rel="stylesheet" media="screen" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700">
	<link rel="stylesheet" href="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/css/font-awesome.min.css">

	<!-- Custom styles for our template -->
	<link rel="stylesheet" href="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/css/bootstrap-theme.css" media="screen" >
	<link rel="stylesheet" href="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/css/main.css">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><img src="<?php $url = str_replace('/signin.php', '', $_SERVER['REQUEST_URI']) ;  echo($url); ?>/images/logo.png" alt="Progressus php5 templates"></a>
			</div>

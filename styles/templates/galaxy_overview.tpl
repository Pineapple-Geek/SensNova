...
<div id="eins_small">
	...
	<tr>
	<td style='width:80'>
	<img src='styles/theme/{$Raza_skin}/planeten/small/s_{$GalaxyRow.planet.image}.png' height='75' width=75 />
	</td>
	<td>
	...
	<tr>
	<td style='width:80'>
	<img src='styles/theme/{$Raza_skin}/planeten/small/s_mond.png' height='75' style='width:75' />
	</td>
	<td>
